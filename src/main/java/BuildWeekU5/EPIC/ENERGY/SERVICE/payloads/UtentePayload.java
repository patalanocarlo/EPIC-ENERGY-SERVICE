...
public record UtentePayload(
        ...
        @Size(min = 3, max = 40, message = "Username deve essere compreso fra 3 e 10 caratteri")
        String userName,
       ...
       @Size(min = 3, max = 40, message = "Nome deve essere compreso fra 3 e 15 caratteri")
        String nome,

        @NotEmpty(message = "Il campo Cognome è obbligatorio!")
       @Size(min = 3, max = 40, message = "Cognome deve essere compreso fra 3 e 10 caratteri")
        String cognome
) {}